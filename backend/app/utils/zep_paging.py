"""
Herramienta de lectura paginada de Zep Graph.

La interfaz de lista node/edge de Zep usa paginacion con cursor UUID,
este modulo encapsula la logica de paginacion automatica (incluyendo reintento de pagina unica),
devolviendo una lista completa de manera transparente al llamador.
"""
