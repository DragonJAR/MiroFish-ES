...
class GraphBuilderService:
    ...
    def _build_graph_worker(
        ...
        try:
            ...
            self.task_manager.update_task(
                task_id,
                progress=20,
                message=f"Texto dividido en {total_chunks} chunks"
            )
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # Esta es la forma requerida por Zep SDK, las advertencias vienen de la creación dinámica de clases y pueden ignorarse
        ...
        for edge_def in ontology.get("edge_types", []):
            ...
            for attr_def in edge_def.get("attributes", []):
                ...
                # Zep API necesita Field con description, esto es obligatorio
                attrs[attr_name] = Field(description=attr_desc, default=None)
                annotations[attr_name] = Optional[str]  # Atributos de borde usan tipo str
    ...
    def add_text_batches(
        ...
        for i in range(0, total_chunks, batch_size):
            ...
            try:
                ...
                # Recolectar los UUIDs de episodes devueltos
                ...
                # Evitar demasiadas peticiones seguidas
                time.sleep(1)
    ...
    def _wait_for_episodes(
        ...
        if progress_callback:
            progress_callback(f"Esperando procesamiento de {total_episodes} chunks de texto...", 0)
        ...
        while pending_episodes:
            ...
            if progress_callback:
                progress_callback(
                    f"Procesando en Zep... {completed_count}/{total_episodes} completados, {len(pending_episodes)} pendientes ({elapsed}seg)",
